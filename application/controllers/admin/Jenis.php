...
class Jenis extends CI_Controller {
	...
	public function tambah()
	{
		...
		$valid->set_rules('NAMA_JENIS_BAJU_M','Nama_jenis','required|min_length[5]|max_length[32]|is_unique[T_JENIS_BAJU_M.NAMA_JENIS_BAJU_M]',
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'NAMA_JENIS_BAJU_M'			=> $i->post('NAMA_JENIS_BAJU_M'));
	...
	public function edit($id_jenis)
	{
		...
		// Masuk database
			...
			$i = $this->input;
			$data = array(	'ID_JENIS_M'			=> $id_jenis,
							'NAMA_JENIS_BAJU_M'		=> $i->post('NAMA_JENIS_BAJU_M')
						);
